...
function MoviesCard({ movie, index = 0, type = 'standard', genreCard, removeFromPageMovies, handleDeleteWatchlist, handleDeleteMovie }: MoviesCardProps) {
    ...
    const renderAdminControls = () => {
        ...
        return (
            <>
                <motion.button
                    onClick={handleEdit}
                    className="absolute bottom-16 left-4 z-30 opacity-0 group-hover:opacity-100 flex items-center justify-center
                    w-10 h-10 rounded-full
                    bg-white/10 backdrop-blur-[6px]
                    border-2 border-blue-400/30
                    shadow-[0_2px_12px_0_rgba(30,144,255,0.15)]
                    transition-all duration-200
                    hover:shadow-[0_0_16px_4px_rgba(30,144,255,0.25)]
                    hover:bg-blue-400/20 hover:border-blue-400
                    hover:text-blue-50
                    focus:outline-none"
                    whileHover={{ scale: 1.15, boxShadow: "0 0 24px 6px rgba(30,144,255,0.25)" }}
                    whileTap={{ scale: 0.95 }}
                ...
                <motion.button
                    ...
                    shadow-[0_2px_12px_0_rgba(240,44,73,0.15)]
                    transition-all duration-200
                    hover:shadow-[0_0_16px_4px_rgba(240,44,73,0.25)]
                    hover:bg-red-400/20 hover:border-red-400
                    hover:text-red-50
                    focus:outline-none"
                    whileHover={{ scale: 1.15, boxShadow: "0 0 24px 6px rgba(240,44,73,0.25)" }}
                    whileTap={{ scale: 0.95 }}
    ...
    if (type === 'watchlist') {
        return (
            <div className="w-full max-w-xs md:max-w-[22rem] 2xl:max-w-[27rem] mx-auto mb-4">
                <div
