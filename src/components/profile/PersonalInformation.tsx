...
export class PersonalInformation extends Component<any> {
    ...
    {/* Corner screws/bolts for metallic plate look */}
    ...
    <div className="p-6 relative z-10">
        {/* Header with metal plate styling */}
        <div className={`flex items-center justify-between border-b pb-3 mb-5 ${
            ...
            {/* Status indicator - embossed/debossed effect */}
            {!loading && subscriptionDetails && (
                <span className={`text-xs px-3 py-1 rounded-full flex items-center
                    ...
                    <span className={`font-medium ${
                        currentPlan !== 'basic' ? 'text-black/80' : ''
                    }`}>{getStatusDisplay()}</span>
                </span>
            )}
        </div>

        {/* Content with appropriate text colors for each metal type */}
        {loading ? (
            <div className="h-52 flex flex-col items-center justify-center gap-3">
                ...
                <span className={`text-sm ${
                    currentPlan !== 'basic' ? 'text-black/70' : 'text-gray-400'
            ...
            <div className="text-red-600 flex flex-col items-center gap-2 text-center py-8 text-sm">
                ...
                <button onClick={() => window.location.href = '/subscription'}
                    className={`mt-2 border rounded-md px-4 py-2 transition-all duration-300 hover:scale-105 ${
                        currentPlan !== 'basic' 
            ...
            <div className="space-y-6">
                {/* Plan info box */}
                <div className={`rounded-xl relative overflow-hidden backdrop-blur-sm ${
                    currentPlan === 'gold'
                    ...
                    {/* Inner metallic texture for premium plans */}
                    {currentPlan !== 'basic' && (
                    ...
                    <div className="p-5 relative z-10">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                {/* Embossed medallion with premium icon */}
                                ...
                                <div>
                                    <span className={`text-lg font-bold block ${
                                        currentPlan === 'basic' ? 'text-white' : 'text-black/80'
                                    }`}>
                                        {planInfo.name} Plan
                                    </span>
                                    <span className={`text-xs px-2 py-0.5 rounded-md inline-block mt-1 font-medium ${
                                        currentPlan === 'gold'
                            ...
                            <div className="text-right">
                                ...
                                <span className={`text-xs ${
                                    currentPlan === 'basic' ? 'text-gray-400' : 'text-black/60'
                                }`}>
                ...
                {/* Rest of the content - features and button with metallic styling */}
                {/* ... features section with appropriate metallic styling ... */}
