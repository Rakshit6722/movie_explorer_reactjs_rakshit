    ...
    render() {
        ...
        return (
            <motion.div
                ...
                className="bg-black/60 backdrop-blur-lg border border-white/10 p-8 rounded-xl w-full shadow-xl"
            >
                <h2 className="font-anton text-3xl mb-8 font-bold text-center bg-gradient-to-r from-red-500 to-orange-400 bg-clip-text text-transparent">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div className="relative">
                                ...
                                <div
                                    ...
                                    ${formData.poster ? 'border-gray-600 bg-gradient-to-b from-gray-800 to-gray-900' :
